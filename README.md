...
Above: Upper section of the DataSet tab
...
Above: Lower section of Dataset tab , obviously pressing the Auto-Label All and then the Save buttons on the screen

<img width="1864" height="564" alt="image" src="https://github.com/user-attachments/assets/51bdf114-5226-4d8b-8143-0701893793ad" />

Above: The Preprocess tab , apart from adjusting the folder name for clarity, just press the Preprocess button to start making the pt files (this tab automatically uses the dataset you made in the Dataset tab) 


<img width="1873" height="1018" alt="image" src="https://github.com/user-attachments/assets/34d625a9-a32f-45e3-b706-9d97ecda6955" />

Above: Upper half of the Training tab, I select my GPU and it puts in the values - I adjust some , epochs I increase to 1500 (it doesn't matter as it auto stops when it sees that the epochs aren't getting better) . I also increase the Rank and Alpha .

<img width="936" height="907" alt="image" src="https://github.com/user-attachments/assets/29c7123b-4a37-40b4-aa24-878b158f5466" />

Above: Middle section of the training tab , I increase the Steps to max
...
Above: Adjusting the output lora directory, just a matter of pressing Start Training and then Export after it's done. 
